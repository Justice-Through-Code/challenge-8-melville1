...
# Is a list with dictionaries as elements- the squirly braces
...
def search_by_author(author):
    search = []
    for dictionary in books_with_details:
        if dictionary['author'] == author:
            search.append(dictionary['title'])
    return search
